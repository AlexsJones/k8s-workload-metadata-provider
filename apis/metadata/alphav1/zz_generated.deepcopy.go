...
func (in *MetaDataContextSpec) DeepCopyInto(out *MetaDataContextSpec) {
	*out = *in
	if in.DataMappingExample != nil {
		in, out := &in.DataMappingExample, &out.DataMappingExample
...
func (in *MetaDataContextTypeList) DeepCopyInto(out *MetaDataContextTypeList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]MetaDataContextType, len(*in))
		for i := range *in {
...
func (in *MetaDataContextTypeList) DeepCopy() *MetaDataContextTypeList {
	...
	out := new(MetaDataContextTypeList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetaDataContextTypeStatus) DeepCopy() *MetaDataContextTypeStatus {
	...
	out := new(MetaDataContextTypeStatus)
	in.DeepCopyInto(out)
	return out
}
